...
"""
    ...
    path = ["post", "perform"]
    permissions = ["android.permission.CALL_PHONE", "com.WithSecure.dz.permissions.GET_CONTEXT"]
    ...
    def execute(self, arguments):
        ...
        intent = android.Intent(action="android.intent.action.CALL", data_uri="tel:" + arguments.number,
